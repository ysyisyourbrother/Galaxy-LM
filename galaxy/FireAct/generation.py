...
if __name__ == '__main__':
    ...
    perfix = args.task +   "_" + time_str +  "_" +args.modelpath.split("/")[-1]
    print("perfix:", perfix  )
    ...
    search_save(perfix )
    print("Search call count:",  tools.call_count)