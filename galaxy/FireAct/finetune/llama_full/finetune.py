...
def make_supervised_data_module(tokenizer: transformers.PreTrainedTokenizer, data_args) -> Dict:
    ...
    print("finish make dataset and collator")
...
def train():
    ...
    logging_dir_with_time = os.path.join(training_args.logging_dir, f"{current_time}")
    training_args.logging_dir = logging_dir_with_time = logging_dir_with_time
