...
def train(
    ...
    logging_dir_with_time = os.path.join(logging_dir, f"{current_time}")
    # 如果目录不存在，则创建它
    if not os.path.exists(logging_dir_with_time):
        os.makedirs(logging_dir_with_time)
    trainer = transformers.Trainer(
        ...
        args=transformers.TrainingArguments(
            ...
            report_to = report_to,
            logging_dir = logging_dir_with_time
        ),
