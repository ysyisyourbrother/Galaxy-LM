...
from data import TaskDataCollatorForSeq2Seq, DataCollatorForT5MLM
...
def main():
    ...
    if "fisher" in adapter_args.load_side_pretrained_weights:
        ...
        if adapter_args.use_bottleneck:
            from  pruning.pruning_methods import pruning_bottleneck
            method = pruning_bottleneck
        if adapter_args.create_side_lm:
            from  pruning.pruning_methods import pruning_with_residual
    ...
    if adapter_args.train_side_transformer:
        if adapter_args.use_bottleneck:
            from  third_party.models.t5.modeling_bottleneck_t5 import T5ForConditionalGeneration
        elif adapter_args.use_updown:
            from  third_party.models.t5.modeling_side_updown_t5 import T5ForConditionalGeneration
        ...
        from  third_party.models.t5.modeling_cross_side_t5 import T5ForConditionalGeneration
