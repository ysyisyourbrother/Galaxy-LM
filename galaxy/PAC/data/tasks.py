...
class MRPC(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'mrpc', split=split, script_version="master")
...
class COLA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'cola',
...
class SST2(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'sst2',
                                     split=split, script_version="master")
...
class STSB(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'stsb',
                                     split=split, script_version="master")
...
class QQP(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'qqp',
                                     split=split, script_version="master")
...
class MNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'mnli', split=split, script_version="master")
...
class QNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'qnli', split=split, script_version="master")
...
class RTE(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset("./datasets/glue",
                                     'rte',
                                     split=split, script_version="master" )
    def preprocessor(self, example, add_prefix=True):
        src_texts = ["sentence1:", example['sentence1'],
...
class WNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset( "./datasets/glue", 'wnli', split=split, script_version="master")
